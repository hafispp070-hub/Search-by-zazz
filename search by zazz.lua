...
local currentFilter = "All" -- All, Game, Universal
...
local function AddResultCard(data)
    ...
    Views.Text = "Views: ".. (data.views or 0).. " | ".. (data.verified and "✓ Verified" or "Unverified")
